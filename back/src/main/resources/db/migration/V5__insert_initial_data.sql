...
INSERT INTO insurance_packages (id, user_id, name, description, baseprice, discount, active, package_type) VALUES
(1, 1, 'Базовый пакет', 'Базовый страховой пакет', 10000.00, 0, true, 'CUSTOM'),
(2, 1, 'Стандартный пакет', 'Стандартный страховой пакет', 15000.00, 5, true, 'CUSTOM'),
(3, 1, 'Премиум пакет', 'Премиум страховой пакет', 25000.00, 10, true, 'CUSTOM');
